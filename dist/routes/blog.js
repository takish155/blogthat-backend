...
const { createBlog, deleteBlog, getBlog, getBlogById, getRecommendedBlog, updateBlog, } = BlogController_1.default;
const { checkBlogField, checkBlogOwnership, checkBlogQuery } = BlogMiddleware_1.default;
